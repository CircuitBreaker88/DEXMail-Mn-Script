...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='dexmail.conf'
ORIGFOLDER='/root/.dxm'
CONFIGFOLDER="/root/.dxm-$1"
COIN_DAEMON='dexmaild'
COIN_CLI='dexmail-cli'
...
read -p "DXM Port: " -i $DEFAULT_COIN_PORT -e COIN_PORT
...
/usr/local/bin/dexmail-cli -conf=$CONFIGFOLDER/$CONFIG_FILE -datadir=$CONFIGFOLDER \$@
EOF
